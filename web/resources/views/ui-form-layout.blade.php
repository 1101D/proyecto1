@extends('partials.layouts.master2')
    ...
    @section('title', 'Form Layout | Eventz')
                ...
                <div class="card-body">
                    <form action="#!">
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" id="formLayout2-dob" placeholder="Date of Birth" required>
                            </div>
                            <div class="col-12">
                ...
                <div class="card-body">
                    <form action="#!">
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                <label for="dateOfBirthLayout3" class="form-label">Date of Birth</label>
                                <input type="text" class="form-control" id="dateOfBirthLayout3" placeholder="Date of Birth" required>
                            </div>
                            <div class="col-md-6">
                ...
                <div class="card-body">
                    <form action="#!">
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                <label for="dateOfBirthLayout4" class="form-label">Date of Birth</label>
                                <div class="form-icon">
                                    <i class="ri-calendar-line text-muted"></i>
                                    <input type="text" class="form-control form-control-icon" id="dateOfBirthLayout4" placeholder="Date of Birth" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                    ...
                    <form action="#!">
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-9 form-icon">
                                <i class="ri-user-line text-muted"></i>
                                <input type="text" class="form-control form-control-icon" id="firstNameLayout6" placeholder="Full Name">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-lg-3 d-flex align-items-center">
