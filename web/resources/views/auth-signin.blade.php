...
@section('title', 'Iniciar sesión | Eventz')
                ...
                <div class="col-lg-6">
                    <div class="auth-box card card-body m-0 h-100 border-0 justify-content-center">
                        <div class="mb-5 text-center">
                            ...
                            <p class="text-muted mb-0">Ingresá tus datos para acceder a tu cuenta.</p>
                        </div>
                        @if ($errors->any())
                        ...
                        <form class="form-custom mt-10" method="POST" action="{{ route('login.attempt') }}">
                            ...
                            <div class="center-hr my-10 text-nowrap text-muted">O con tu email</div>
