...
@section('title', 'Two Step Verification | Eventz
    SRBThemes')
                ...
                <div class="col-lg-6">
                    <div class="auth-box card card-body m-0 h-100 border-0 justify-content-center">
                        <div class="mb-5 text-center">
                            <h4 class="fw-medium">Confirm Your Email Address</h4>
                            <p class="text-muted mb-0">To complete the verification process, please input the 4-digit code
                                sent to example@abc.com.</p>
                        </div>
                        <form class="form-custom mt-10 max-w-384px mx-auto">

                            <div id="otp-container" class="d-flex align-items-center justify-content-center gap-2">
                                <input type="number" class="form-control text-center min-h-50px" placeholder="0"
                                    data-otp-input maxlength="1" aria-label="OTP digit 1">
                                <input type="number" class="form-control text-center min-h-50px" placeholder="0"
                                    data-otp-input maxlength="1" aria-label="OTP digit 2">
                                <input type="number" class="form-control text-center min-h-50px" placeholder="0"
                                    data-otp-input maxlength="1" aria-label="OTP digit 3">
                                <input type="number" class="form-control text-center min-h-50px" placeholder="0"
                                    data-otp-input maxlength="1" aria-label="OTP digit 4">
                            </div>

                            <a href="auth-signin">
                                <button type="button" class="btn btn-primary rounded-2 w-100 btn-loader text-center mt-10">
                            ...
                            <p class="mb-0 mt-5 text-muted text-center">
                                Don't receive code ?
                                <a href="auth-reset-password" class="text-primary fw-medium text-decoraton-underline ms-1">
                                    Resend
                                </a>
                            </p>
                        </form>
