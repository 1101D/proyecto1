...
@section('title', 'Crear cuenta | Eventz')
                ...
                <div class="col-lg-6">
                    <div class="auth-box card card-body m-0 h-100 border-0 justify-content-center">
                        <div class="mb-5 text-center">
                            <h4 class="fw-normal">Bienvenido a <span class="fw-bold text-primary">Eventz</span></h4>
                            <p class="text-muted mb-0">Creá tu cuenta para empezar a usar Eventz.</p>
                        </div>
                        @if ($errors->any())
                        ...
                        <form class="form-custom mt-10" method="POST" action="{{ route('register.attempt') }}">
                            @csrf

                            <div class="mb-5">
                                <label class="form-label" for="login-username">Nombre<span
                            ...
                            <div class="mb-5">
                                <label class="form-label" for="login-password-confirm">Confirmar password<span
                                        class="text-danger ms-1">*</span></label>
                                <input type="password" id="login-password-confirm" class="form-control"
                                    name="password_confirmation" placeholder="Confirm your password" required>
                            </div>

                            <div class="mb-5">
                                <p class="mb-0 fs-xs text-muted fst-italic">Al registrarte aceptás los
                                    <a href="#!"
                            ...
                            <div class="center-hr my-10 text-nowrap text-muted">Crear cuenta con</div>
