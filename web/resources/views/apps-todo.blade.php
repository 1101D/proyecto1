                    ...
                    <div class="card-body py-5">
                        <ul class="list-group fs-13 list-group-flush">
                            ...
                            <li class="list-group-item d-flex hstack rounded px-0 pb-0">
                                <div
                                    class="avatar-item border-0 avatar avatar-title bg-secondary-subtle text-secondary me-3 flex-shrink-0">
                                    LP</div>
                                <div class="d-flex align-items-center flex-row-fluid flex-wrap flex-grow-1">
                                    <div class="flex-grow-1 me-2">
                ...
                <div class="card card-h-100 overflow-hidden">
                    <div class="card-header hstack justify-content-between gap-3">
                        ...
                        <a href="#!" class="btn btn-light btn-sm" data-bs-toggle="modal"
                            data-bs-target="#addTasksModal">Create Task</a>
                    </div>
                    <div class="card-body h-100">
                        <ul class="nav nav-pills nav-justified gap-2 flex-nowrap mb-8 overflow-x-hide-scroll"
                            role="tablist">
                            <li class="nav-item p-0 ms-0" role="presentation">
                                <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3 active"
                                    data-bs-toggle="tab" href="#weekly-report-1" aria-selected="false" role="tab"
                                    tabindex="-1">
                            ...
                            <li class="nav-item p-0 ms-0" role="presentation">
                                <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3"
                                    data-bs-toggle="tab" href="#weekly-report-2" aria-selected="false" role="tab"
                                    tabindex="-1">
                            ...
                            <li class="nav-item p-0 ms-0" role="presentation">
                                <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3"
                                    data-bs-toggle="tab" href="#weekly-report-3" aria-selected="false" role="tab"
                                    tabindex="-1">
                            ...
                            <li class="nav-item p-0 ms-0" role="presentation">
                                <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3"
                                    data-bs-toggle="tab" href="#weekly-report-4" aria-selected="false" tabindex="-1"
                                    role="tab">
                            ...
                            <li class="nav-item p-0 ms-0" role="presentation">
                                <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3"
                                    data-bs-toggle="tab" href="#weekly-report-5" aria-selected="false" tabindex="-1"
                                    role="tab">
                            ...
                            <li class="nav-item p-0 ms-0" role="presentation">
                                <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3"
                                    data-bs-toggle="tab" href="#weekly-report-6" aria-selected="false" tabindex="-1"
                                    role="tab">
                            ...
                            <li class="nav-item p-0 ms-0" role="presentation">
                                <a class="nav-link btn d-flex flex-column flex-center rounded-pill min-w-45px py-4 px-3"
                                    data-bs-toggle="tab" href="#weekly-report-7" aria-selected="false" role="tab"
                                    tabindex="-1">
                        ...
                        <div class="tab-content mb-2">
                            <div class="tab-pane fade active show" id="weekly-report-1" role="tabpanel">
                                ...
                                <div class="d-flex align-items-center mb-6">
                                    ...
                                    <div class="flex-grow-1 overflow-hidden me-5">
                                        <h5 class="fw-semibold mb-0">11:30 - 12:00<span
                                                class="text-muted fw-semibold fs-12 ms-1">PM </span></h5>
                                ...
                                <div class="d-flex align-items-center mb-6">
                                    ...
                                    <div class="flex-grow-1 me-5">
                                        <h5 class="fw-semibold mb-0">12:15 - 12:45<span
                                                class="text-muted fw-semibold fs-12 ms-1">PM </span></h5>
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 me-5">
                                        <h5 class="fw-semibold mb-0">1:00 - 1:30<span
                                                class="text-muted fw-semibold fs-12 ms-1">PM </span></h5>
                            ...
                            <div class="tab-pane fade" id="weekly-report-2" role="tabpanel">
                                <div class="d-flex align-items-center mb-6">
                                    ...
                                    <div class="flex-grow-1 me-5">
                                        <h5 class="fw-semibold mb-0">9:30 - 10:00<span
                                                class="text-muted fw-semibold fs-12 ms-1">AM </span></h5>
                                ...
                                <div class="d-flex align-items-center mb-6">
                                    ...
                                    <div class="flex-grow-1 me-5">
                                        <h5 class="fw-semibold mb-0">10:15 - 10:45<span
                                                class="text-muted fw-semibold fs-12 ms-1">AM </span></h5>
                                ...
                                <div class="d-flex align-items-center mb-6">
                                    ...
                                    <div class="flex-grow-1 me-5">
                                        <h5 class="fw-semibold mb-0">11:00 - 11:30<span
                                                class="text-muted fw-semibold fs-12 ms-1">AM </span></h5>
                            ...
                            <div class="tab-pane fade" id="weekly-report-3" role="tabpanel">
                                <div class="d-flex align-items-center mb-6">
                                    <span class="bullet d-flex align-items-center me-4 bg-warning"></span>
                                    <div class="flex-grow-1 me-5">
                                        <h5 class="fw-semibold mb-0">8:00 - 8:30<span
                                                class="text-muted fw-semibold fs-12 ms-1">AM </span></h5>
                                ...
                                <div class="d-flex align-items-center mb-6">
                                    ...
                                    <div class="flex-grow-1 me-5">
                                        <h5 class="fw-semibold mb-0">10:00 - 10:30<span
                                                class="text-muted fw-semibold fs-12 ms-1">AM </span></h5>
                                ...
                                <div class="d-flex align-items-center mb-6">
                                    <span class="bullet d-flex align-items-center me-4 bg-success"></span>
                                    <div class="flex-grow-1 me-5">
                                        <h5 class="fw-semibold mb-0">1:30 - 2:00<span
                                                class="text-muted fw-semibold fs-12 ms-1">PM </span></h5>
                            ...
                            <div class="tab-pane fade " id="weekly-report-4" role="tabpanel">
                                <div class="d-flex align-items-center mb-6">
                                    ...
                                    <div class="flex-grow-1 me-5">
                                        <h5 class="fw-semibold mb-0">3:00 - 3:30<span
                                                class="text-muted fw-semibold fs-12 ms-1">PM </span></h5>
                                ...
                                <div class="d-flex align-items-center mb-6">
                                    <span class="bullet d-flex align-items-center me-4 bg-info"></span>
                                    <div class="flex-grow-1 me-5">
                                        <h5 class="fw-semibold mb-0">4:00 - 4:30<span
                                                class="text-muted fw-semibold fs-12 ms-1">PM </span></h5>
                                ...
                                <div class="d-flex align-items-center mb-6">
                                    <span class="bullet d-flex align-items-center me-4 bg-danger"></span>
                                    <div class="flex-grow-1 me-5">
                                        <h5 class="fw-semibold mb-0">5:00 - 5:30<span
                                                class="text-muted fw-semibold fs-12 ms-1">PM </span></h5>
                            ...
                            <div class="tab-pane fade " id="weekly-report-5" role="tabpanel">
                                <div class="d-flex align-items-center mb-6">
                                    <span class="bullet d-flex align-items-center me-4 bg-success"></span>
                                    <div class="flex-grow-1 me-5">
                                        <h5 class="fw-semibold mb-0">10:45 - 11:15<span
                                                class="text-muted fw-semibold fs-12 ms-1">AM </span></h5>
                                ...
                                <div class="d-flex align-items-center mb-6">
                                    <span class="bullet d-flex align-items-center me-4 bg-primary"></span>
                                    <div class="flex-grow-1 me-5">
                                        <h5 class="fw-semibold mb-0">12:00 - 12:30<span
                                                class="text-muted fw-semibold fs-12 ms-1">PM </span></h5>
                                ...
                                <div class="d-flex align-items-center mb-6">
                                    <span class="bullet d-flex align-items-center me-4 bg-warning"></span>
                                    <div class="flex-grow-1 me-5">
                                        <h5 class="fw-semibold mb-0">2:00 - 2:30<span
                                                class="text-muted fw-semibold fs-12 ms-1">PM </span></h5>
                            ...
                            <div class="tab-pane fade " id="weekly-report-6" role="tabpanel">
                                <div class="d-flex align-items-center mb-6">
                                    <span class="bullet d-flex align-items-center me-4 bg-info"></span>
                                    <div class="flex-grow-1 me-5">
                                        <h5 class="fw-semibold mb-0">8:30 - 9:00<span
                                                class="text-muted fw-semibold fs-12 ms-1">AM </span></h5>
                                ...
                                <div class="d-flex align-items-center mb-6">
                                    <span class="bullet d-flex align-items-center me-4 bg-secondary"></span>
                                    <div class="flex-grow-1 me-5">
                                        <h5 class="fw-semibold mb-0">3:45 - 4:15<span
                                                class="text-muted fw-semibold fs-12 ms-1">PM </span></h5>
                            ...
                            <div class="tab-pane fade" id="weekly-report-7" role="tabpanel">
                                <div class="d-flex align-items-center mb-6">
                                    <span class="bullet d-flex align-items-center me-4 bg-primary"></span>
                                    <div class="flex-grow-1 me-5">
                                        <h5 class="fw-semibold mb-0">7:45 - 8:15<span
                                                class="text-muted fw-semibold fs-12 ms-1">AM </span></h5>
                    ...
                    <div class="card-body px-2 py-4">
                        <div class="vstack">
                            <div id="task-overview"
                                class="position-relative d-flex flex-center h-175px w-175px me-10 mb-7 flex-shrink-0">
                            </div>
                            <div
                                class="d-flex flex-column justify-content-center flex-row-fluid flex-grow-1 px-4 px-lg-10">
