...
@section('title', 'Under Maintenance | Eventz')
    ...
    <div class="account-pages">
        <img src="{{ asset('assets/images/auth/auth_bg.jpeg') }}" alt="Auth Image" class="auth-bg light">
        <img src="{{ asset('assets/images/auth/auth_bg_dark.jpg') }}" alt="Auth Image" class="auth-bg dark">
        <div class="container">
                ...
                <div class="col-lg-8">
                    <div class="auth-box card card-body m-0 h-100 border-0 justify-content-center">
                        <div class="mb-5 text-center">
                            ...
                            <p class="text-muted mb-0">We're working on an additional feature for you; give us some time, and we'll notify you soon.</p>
                        </div>
                        <img class="max-h-320px mx-auto" src="{{ asset('assets/images/vector/under-maintenance.svg') }}" alt="Auth Image">
                        <form class="form-custom mt-10">
                            ...
                            <div class="position-relative subscribe-btn mt-10 max-w-500px mx-auto">
                                <input type="text" class="form-control form-control-lg fs-14 min-h-56px form-control-icon rounded-pill" id="companyNameLayout4" placeholder="Enter Your Email" required>
