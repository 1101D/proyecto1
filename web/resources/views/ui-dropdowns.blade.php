@extends('partials.layouts.master2')
    ...
    @section('title', 'Dropdowns | Eventz')
    @section('sub-title', 'Dropdowns' )
    ...
    <div class="col-lg-12">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <p class="text-muted">Create <strong class="text-body fw-medium">dropdowns</strong> with Bootstrap using the <code>&lt;div class="dropdown"&gt;</code> class and <code>&lt;button class="btn btn-secondary dropdown-toggle"&gt;</code> for the toggle. Include <code>&lt;ul class="dropdown-menu"&gt;</code> for the menu items.</p>
    ...
    <div class="col-lg-12">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <p class="text-muted">Use <strong class="text-body fw-medium">dropdown color variants</strong> in Bootstrap by applying color classes like <code>.btn-primary</code> or <code>.btn-success</code> to the <code>&lt;button class="btn btn-primary"&gt;</code> for different styles.</p>
    ...
    <div class="col-lg-12">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <p class="text-muted">Create a <strong class="text-body fw-medium">split button dropdown</strong> with Bootstrap by using <code>.btn-group</code> and <code>.dropdown-toggle-split</code> classes. Apply these to separate the button and dropdown toggle.</p>
    ...
    <div class="col-lg-12">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <p class="text-muted">Style <strong class="text-body fw-medium">dark dropdowns</strong> with Bootstrap by using the <code>.dropdown-menu-dark</code> class on the <code>&lt;ul&gt;</code> element for a dark theme.</p>
    ...
    <div class="col-lg-12">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <p class="text-muted">Enable <strong class="text-body fw-medium">hover dropdowns</strong> with Bootstrap by using the <code>.dropdown-hover</code> class. Apply this class to the <code>&lt;div class="dropdown"&gt;</code> container for dropdowns that appear on hover.</p>
    ...
    <div class="col-lg-12">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <p class="text-muted">Align <strong class="text-body fw-medium">dropdown menus</strong> with Bootstrap using <code>.dropdown-menu-end</code> to right-align and <code>.dropdown-menu-start</code> to left-align the dropdown menu relative to the toggle button.</p>
            ...
            <div class="col-lg-6">
              <div class="btn-group">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a class="dropdown-item" href="#!">New Ticket</a></li>
                  <li><a class="dropdown-item" href="#!">New Customer</a></li>
                  <li class="dropend">
                    <a class="dropdown-item dropdown-toggle" role="button" id="dropdownMenuButton2" data-bs-toggle="dropdown" data-bs-offset="-9,2" aria-expanded="false" href="#!">New Group</a>
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
                      <li><a class="dropdown-item" href="#!">Admin Group </a></li>
                      <li><a class="dropdown-item" href="#!">Staff Group </a></li>
                      <li><a class="dropdown-item" href="#!">Member Group </a></li>
                    </ul>
                  </li>
    ...
    <div class="col-lg-12">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <p class="text-muted">Customize <strong class="text-body fw-medium">dropdown options</strong> in Bootstrap with <code>data-bs-offset</code> to adjust the dropdown position and <code>data-bs-reference</code> to specify the reference element for positioning.</p>
    ...
    <div class="col-lg-12">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <p class="text-muted">Control <strong class="text-body fw-medium">auto-close behavior</strong> of dropdowns in Bootstrap using the <code>data-bs-auto-close</code> attribute. Set it to <code>"true"</code>, <code>"outside"</code>, or <code>"inside"</code> to define when the dropdown should close automatically.</p>
        ...
        <div class="card-body">
          ...
          <div class="row">
            <div class="col-lg-6">
              ...
              <p class="text-muted">Add<code> .disabled </code>to items in the dropdown to <strong class="text-body fw-medium">style them as disabled</strong></p>
        ...
        <div class="card-body">
          ...
          <div class="d-flex flex-wrap gap-3">
            ...
            <div class="btn-group">
              ...
              <div class="dropdown-menu">
                <div class="dropdown-header"> Welcome Herozi User! </div>
                <!-- item-->
                <a class="dropdown-item" href="#!">Action</a>
                <a class="dropdown-item" href="#!">Another action</a>
                <a class="dropdown-item" href="#!">Something else here</a>
            ...
            <div class="btn-group">
              ...
              <div class="dropdown-menu p-4 min-w-200px">
                <form>
                  ...
                  <div class="mb-2">
                    <div class="form-check form-check-sm d-flex align-items-center gap-2 mb-3">
                      <input type="checkbox" class="form-check-input" id="rememberdropdownCheck">
                      <label class="form-check-label mb-0" for="rememberdropdownCheck">Remember me</label>
                    </div>
                  </div>
