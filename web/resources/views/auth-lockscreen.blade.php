...
@section('title', 'Lock Screen | Eventz')
                ...
                <div class="col-lg-6">
                    <div class="auth-box card card-body m-0 h-100 border-0 justify-content-center">
                        ...
                        <div class="d-flex flex-column align-items-center">
                            <div class="h-100px w-100px overflow-hidden rounded-pill">
                                <img src="{{ asset('assets/images/avatar/avatar-4.jpg') }}"
                                    class="rounded-pill img-thumbnail h-100 w-100" alt="thumbnail">
                            </div>
                            <h5 class="font-size-15 mt-3">Hi ! Richard Marshall</h5>
                            <p class="text-muted mb-0">Enter your password to unlock the screen!</p>
                        </div>
                        ...
                        <form class="form-custom mt-10">
                            ...
                            <div class="mb-5">
                                ...
                                <div class="input-group">
                                    <input type="password" id="LoginPassword" class="form-control" value="123456"
                                        name="password" placeholder="Enter your password" data-visible="false">
                            ...
                            <a href="index" class="text-center mt-5 pt-5">
