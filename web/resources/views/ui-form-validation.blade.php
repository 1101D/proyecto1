@extends('partials.layouts.master2')
    ...
    @section('title', 'Form Validation | Eventz')
            ...
            <div class="card h-100 mb-0">
                ...
                <div class="card-body">
                    <form class="row g-3">
                        ...
                        <div class="col-12">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="terms and conditions" id="invalidCheck2" required>
            ...
            <div class="card h-100 mb-0">
                ...
                <div class="card-body">
                    <form class="row g-3">
                        ...
                        <div class="col-12">
                            <div class="form-check">
                                <input class="form-check-input is-invalid" type="checkbox" value="terms and conditions" id="invalidCheck3" aria-describedby="invalidCheck3Feedback" required>
