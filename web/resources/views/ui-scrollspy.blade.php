...
@section('title', 'UI Scrollspy | Eventz')
@section('sub-title', 'ScrollSpy')
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <!-- start:: Default ScrollSpy -->
                    <nav class="navbar card card-body flex-row bg-light bg-opacity-30 border border-dashed shadow-none"
                        id="navbar-example2">
                        <a class="navbar-brand" href="#!">
                            <img class="img-fluid max-w-128px" src="{{ asset('assets/images/light-logo.png') }}">"
                            alt="logo">
                        </a>
                    ...
                    <div class="card card-body bg-light bg-opacity-30 border border-dashed shadow-none max-h-384px overflow-auto"
                        data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-offset="8">
                        <h4 id="scrollspyHeading1">Features</h4>
                        <p class="mb-0">This is some placeholder content for the scrollspy page. Note that as you scroll
                            down the page, the appropriate navigation link is highlighted. It's repeated throughout the
                            component example. We keep adding some more example copy here to emphasize the scrolling and
                            highlighting.</p>
                            ...
                            <div data-bs-spy="scroll" data-bs-target="#navbar-examplenested" data-bs-offset="0"
                                ...
                                <div id="item-1">
                                    ...
                                    <div class="common-align gap-lg-3 gap-1">
                                        <p>Welcome to my experience section! Here, you'll find insights into my professional
                                            journey. As you scroll, the navigation links will dynamically highlight the
                                            corresponding sections. This feature enhances the user experience by providing
                                            clear navigation cues.</p>
                                    </div>
                                </div>
                                <div id="item-1-1">
                                    ...
                                    <p>
                                        ...
                                        responsive websites. This section offers detailed insights into the technologies and
                                        methodologies I've employed. As you scroll, you'll notice the navigation reflecting
                                        your position on the page, ensuring easy access to relevant information.
                                    </p>
                                </div>
                                <div id="item-1-2">
                                    ...
                                    <p>
                                        ...
                                        overview of my experiences and the strategies I implement to safeguard information.
                                        Remember, the scrollspy feature helps highlight the active section as you navigate,
                                        making it easier to track your reading.
                                    </p>
                                    <p>Overall, effectively utilizing Scrollspy can enhance user engagement, making for a
                                        seamless browsing experience on your website.</p>
                                </div>
                                <div id="item-2">
                                    <h6 class="fs-18">Get in Touch</h6>
                                    <div class="common-align gap-lg-3 gap-1">
                                        <p>
                                            I welcome your inquiries! This section outlines how you can connect with me. As
                                            you navigate, the scrollspy will indicate your position, ensuring you can find
                                            the contact information easily. Good organization and clarity in layout
                                            contribute significantly to usability.
                                        </p>
                                        <p>Utilizing Scrollspy effectively can lead to a better user experience and improved
                                            navigation across your site.</p>
                                    </div>
                                </div>
                                <div id="item-3">
                                    <h6 class="fs-18">Projects</h6>
                                    <div class="common-align gap-lg-3 gap-1">
                                        <p>Here, you’ll find a selection of my projects. The scrolling functionality allows
                                            you to explore various works easily, with the navigation highlighting the
                                            relevant sections.</p>
                                    </div>
                                </div>
                                <div id="item-3-1">
                                    ...
                                    <p>
                                        ...
                                        team efforts I’ve participated in. As you scroll, keep an eye on the navigation to
                                ...
                                <div id="item-3-2">
                                    ...
                                    <p>
                                        ...
                                        showcases my solo endeavors. Remember, the scrollspy feature will keep you oriented
                                        as you explore these works.
                                    </p>
                                    <p class="mb-0">In conclusion, effective use of Scrollspy can significantly enhance
                                        the navigation and overall user experience of your website.</p>
                                </div>
                            </div>
                        </div>
                        <!-- end col -->
                    </div>
                    <!-- end:: Nested Scrollspy -->
                </div>
            </div>
            <!--end::card-->
        </div>
                            ...
                            <div data-bs-spy="scroll" data-bs-target="#list-example" data-bs-offset="0"
                                ...
                                <div>
                                    ...
                                    <p class="mb-2 ms-3"><span class="text-body fw-semibold me-2">CSS:</span> A style
                                        sheet language used for describing the presentation of a document written in HTML.
                                    </p>
                                    ...
                                    <p class="mb-2 ms-3"><span class="text-body fw-semibold me-2">Frameworks:</span>
                                        Popular frameworks like React, Angular, and Vue.js enhance development efficiency.
                                    </p>
                                </div>

                                <div class="mt-4">
                                    <h5 class="mb-3" id="list-item-2">Mobile Development</h5>
                                    <p class="mb-2 ms-3"><span class="text-body fw-semibold me-2">iOS Development:</span>
                                        Uses Swift or Objective-C to build applications for Apple devices.</p>
                                    <p class="mb-2 ms-3"><span class="text-body fw-semibold me-2">Android
                                        ...
                                        platform.</p>
                                    <p class="mb-2 ms-3"><span class="text-body fw-semibold me-2">Cross-Platform:</span>
                                        Tools like Flutter and React Native allow for development on multiple platforms.</p>
                                </div>
                                ...
                                <div class="mt-4">
                                    ...
                                    <p class="mb-2 ms-3"><span class="text-body fw-semibold me-2">APIs:</span> RESTful
                                        APIs and GraphQL are key for enabling communication between frontend and backend.
                                    </p>
                                </div>
                                ...
                                <div class="mt-4">
                                    ...
                                    <p class="mb-2 ms-3"><span class="text-body fw-semibold me-2">User Experience:</span>
                                        Enhances the overall experience users have when interacting with a product.</p>
                                    <p class="mb-2 ms-3"><span class="text-body fw-semibold me-2">Prototyping
                                            Tools:</span> Tools like Figma and Adobe XD are essential for creating design
                                        prototypes.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <!-- end:: List Group Scrollspy -->
                </div>
            </div>
            <!--end::card-->
        </div>
