...
@section('title', 'Course Overview | Eventz
    SRBThemes')
            ...
            <div class="card card-h-100 overflow-hidden">
                <div class="card-body p-4 flex-fill h-100 d-flex gap-4 flex-column justify-content-between">
                    ...
                    <div>
                        ...
                        <div class="text-muted fs-12 mt-3"><span class="text-success">75% <i
                                    class="ri-arrow-up-line fs-16 me-1"></i></span> growth in students</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card card-h-100 overflow-hidden">
                <div class="card-body p-4 flex-fill h-100 d-flex gap-4 flex-column justify-content-between">
                    ...
                    <div>
                        ...
                        <div class="text-muted fs-12 mt-3"><span class="text-danger">50% <i
                                    class="ri-arrow-up-line fs-16 me-1"></i></span> growth this month</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card card-h-100 overflow-hidden">
                <div class="card-body p-4 flex-fill h-100 d-flex gap-4 flex-column justify-content-between">
                    <div>
                        ...
                        <h4 class="fw-medium mb-1"><span data-target="25160" data-duration="5" data-suffix="$">25160</span>
                        </h4>
                    </div>
                    <div>
                        <div class="progress progress-xs animated-progess">
                        ...
                        <div class="text-muted fs-12 mt-3"><span class="text-success">20% <i
                                    class="ri-arrow-up-line fs-16 me-1"></i></span> earnings increase</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card card-h-100 overflow-hidden">
                <div class="card-body p-4 flex-fill h-100 d-flex gap-4 flex-column justify-content-between">
                    ...
                    <div>
                        ...
                        <div class="text-muted fs-12 mt-3"><span class="text-info">75% <i
                                    class="ri-arrow-up-line fs-16 me-1"></i></span> engagement rate</div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <ul class="list-group fs-13 fw-medium list-group-flush">
                        ...
                        <li class="list-group-item d-flex hstack rounded px-0 pt-0">
                            ...
                            <div class="d-flex align-items-center flex-row-fluid flex-grow-1">
                                <div class="flex-grow-1 me-2">
                                    <a href="#!" class="fs-6 fw-bold text-body">Bess Willis <small class="text-muted">(
                                            M.Com )</small></a>
                                    <span class="text-danger fw-medium d-block fs-12">Not Available</span>
                                </div>
                                <button type="button" class="btn btn-text-primary rounded-circle icon-btn-sm flex-shrink-0"
                        ...
                        <li class="list-group-item d-flex hstack rounded px-0">
                            ...
                            <div class="d-flex align-items-center flex-row-fluid flex-grow-1">
                                <div class="flex-grow-1 me-2">
                                    <a href="#!" class="fs-6 fw-bold text-body">John Smith <small
                                            class="text-muted">( M.Sc )</small></a>
                                    <span class="text-success fw-medium d-block fs-12">Available</span>
                                </div>
                                <button type="button"
                                    class="btn btn-text-primary rounded-circle icon-btn-sm flex-shrink-0"
                                    data-bs-toggle="dropdown">
                                    <i class="ri-more-2-line fs-14 fw-semibold"></i>
                                </button>
                                <ul class="dropdown-menu">
                        ...
                        <li class="list-group-item d-flex hstack rounded px-0">
                            ...
                            <div class="d-flex align-items-center flex-row-fluid flex-grow-1">
                                <div class="flex-grow-1 me-2">
                                    <a href="#!" class="fs-6 fw-bold text-body">Sophia Adams <small
                                            class="text-muted">( Ph.D )</small></a>
                        ...
                        <li class="list-group-item d-flex hstack rounded px-0">
                            ...
                            <div class="d-flex align-items-center flex-row-fluid flex-grow-1">
                                <div class="flex-grow-1 me-2">
                                    <a href="#!" class="fs-6 fw-bold text-body">Mark Johnson <small
                                            class="text-muted">( B.A. English )</small></a>
                                    <span class="text-danger fw-medium d-block fs-12">Not Available</span>
                                </div>
                                <button type="button"
                                    class="btn btn-text-primary rounded-circle icon-btn-sm flex-shrink-0"
                        ...
                        <li class="list-group-item d-flex hstack rounded px-0">
                            ...
                            <div class="d-flex align-items-center flex-row-fluid flex-grow-1">
                                <div class="flex-grow-1 me-2">
                                    <a href="#!" class="fs-6 fw-bold text-body">Ella Davis <small
                                            class="text-muted">( M.Ed )</small></a>
                                    <span class="text-success fw-medium d-block fs-12">Available</span>
                                </div>
                                <button type="button"
                                    class="btn btn-text-primary rounded-circle icon-btn-sm flex-shrink-0"
                        ...
                        <li class="list-group-item d-flex hstack rounded px-0 pb-0">
                            ...
                            <div class="d-flex align-items-center flex-row-fluid flex-grow-1">
                                <div class="flex-grow-1 me-2">
                                    <a href="#!" class="fs-6 fw-bold text-body">David Lee <small
                                            class="text-muted">( M.S. Computer Science )</small></a>
                                    <span class="text-warning fw-medium d-block fs-12">Away</span>
                                </div>
                                <button type="button"
                                    class="btn btn-text-primary rounded-circle icon-btn-sm flex-shrink-0"
