@extends('partials.layouts.master2')
    ...
    @section('title', 'UI Ratings | Eventz')
        ...
        <div class="col-12 col-sm-6">
            <div class="card h-100 mb-0">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap align-items-center justify-content-between">
                        <p class="fs-14 mb-0 fw-medium">Show Some <span class="text-danger">❤</span> with rating :</p>
                        <div class="d-flex flex-wrap align-items-center gap-3 reset-rating-main">
        ...
        <div class="col-12 col-sm-6">
            <div class="card h-100 mb-0">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap align-items-center justify-content-between">
                        <p class="fs-14 mb-0 fw-medium">Show Some <span class="text-danger">❤</span> with rating :</p>
                        <div class="d-flex flex-wrap align-items-center gap-3" dir="rtl">
                        ...
                        <div class="d-flex flex-wrap align-items-center gap-3">
                            <div class="gl-star-rating gl-star-rating-prebuilt">
                                ...
                                <span class="gl-star-rating--stars">
                                    <span data-value="1" class=""><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="gl-emote">
                                    ...
                                    <span data-value="2" class=""><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="gl-emote">
                                    ...
                                    <span data-value="3" class=""><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="gl-emote">
                                    ...
                                    <span data-value="4" class=""><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="gl-emote">
                                            <circle class="gl-emote-bg" fill="#FFD885" cx="12" cy="12" r="10"></circle>
                                    ...
                                    <span data-value="5" class=""><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="gl-emote">
                                            <circle class="gl-emote-bg" fill="#FFD885" cx="12" cy="12" r="10"></circle>
...
@section('js')
    ...
    <!-- Rating js -->
    <script src="{{ asset('assets/js/plugins/rating.init.js') }}"></script>
