@extends('partials.layouts.master2')
    ...
    @section('title', 'UI Input Masks | Eventz')
    @section('sub-title', 'Input Masks' )
            ...
            <div class="card card-h-100">
                ...
                <div class="card-body">
                    ...
                    <p class="text-muted mb-4">
                        The <strong class="text-body fw-medium">Date Input Fields</strong> example uses Cleave.js for formatted date entry.
                        Configure it with options like <code>date: true</code> and <code>delimiter: '/'</code> for a smooth user experience.
                    </p>
        ...
        <div class="col-12">
            <div class="card card-h-100">
                ...
                <div class="card-body">
                    ...
                    <p class="text-muted mb-4">
                        The <strong class="text-body fw-medium">Time Input Fields</strong> example uses Cleave.js to format time input.
                        Configure it with options like <code>time: true</code> and <code>timePattern: ['h', 'm']</code> for a structured input.
                    </p>
        ...
        <div class="col-12">
            <div class="card mb-0">
                ...
                <div class="card-body">
                    ...
                    <p class="text-muted mb-4">
                        The <strong class="text-body fw-medium">Custom Input Fields</strong> example uses Cleave.js to format input as needed.
                        Configure it with options like <code>delimiter: '-'</code>, <code>blocks: [4, 4, 4, 4]</code>, and <code>uppercase: true</code> for a custom format.
                    </p>
