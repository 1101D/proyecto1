          ...
          child: SingleChildScrollView(
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  const Icon(Icons.confirmation_num_outlined, size: 64, color: Colors.deepPurple),
                  const SizedBox(height: 16),
                  Text('Eventz', style: Theme.of(context).textTheme.headlineMedium, textAlign: TextAlign.center),
                  const SizedBox(height: 8),
                  const Text('Iniciá sesión para reservar tus entradas', textAlign: TextAlign.center),
